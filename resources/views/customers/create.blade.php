            ...
            <div class="card-body">
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cust_code" id="cust_code" class="form-control @error('cust_code') is-invalid @enderror" value="{{ old('cust_code') }}" required>
                        @error('cust_code')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="register_date" id="register_date" class="form-control @error('register_date') is-invalid @enderror" value="{{ old('register_date') }}">
                        @error('register_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
